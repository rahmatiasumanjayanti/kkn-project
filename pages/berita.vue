<template>
   <div class="flex justify-start prose-md items-center px-10 py-10 w-full flex-col gap-8">
        <Navbar
        name="Berita"
        />

        <ul class="w-full h-1/2 grid grid-cols-3 grid-rows-2 justify-center items-center gap-10">
